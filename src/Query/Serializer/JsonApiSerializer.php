...
namespace Pbmengine\Video\Query\Serializer;

use Pbmengine\Video\Query\Builder;
use Pbmengine\Video\Query\Contracts\BuilderSerializer;
use Pbmengine\Video\Query\Exceptions\InvalidDataException;
